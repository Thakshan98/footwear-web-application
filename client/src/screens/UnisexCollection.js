            ...
            {filterApplied&&<div style={
              ...
              <Row style={{
                ...
                {!filterApplied&&products
                  ...
                  {
                    filterApplied&&products
                    .filter((product) => product.gender === 'Unisex'&&product.price>=value[0]&&product.price<=value[1]&&product.rating>=rateFilter[0]&&product.rating<=rateFilter[1]&&(product.cat === categoryFilter || categoryFilter === "Any")) // Filter products by gender
                    .map((product) => (
