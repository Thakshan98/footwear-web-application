          ...
          {loading ? (
            ...
            {filterApplied&&<div style={
              ...
              <div style={
                ...
                } type="text" value={value[0]} readOnly/>
                to<input style={
                  {
                    width: '100%',
                    height: '35px',
                ...
                } type="text" value={value[1]} readOnly/>
                <Slider              
                value={value}
              ...
              <div style={
                ...
                <h3>Rating</h3>
                from<Rating value={rateFilter[0]} readOnly/>
                to<Rating value={rateFilter[1]} readOnly/>
                <Slider              
                value={rateFilter}
              ...
              <Row style={{
                ...
                {!filterApplied&&products
                  .filter((product) => product.gender === 'Female') // Filter products by gender
                  .map((product) => (
                  ...
                  {
                    filterApplied&&products
                    .filter((product) => product.gender === 'Female'&&product.price>=value[0]&&product.price<=value[1]&&product.rating>=rateFilter[0]&&product.rating<=rateFilter[1]&&(product.cat === categoryFilter || categoryFilter === "Any")) // Filter products by gender
                    .map((product) => (
